...
public record EventoRequest(string Nome, string Descricao, string Local, DateTime Data, DateTime DataIniInscricao,
...
string ObsTela, string TxtEmailCadastro, string TxtEmailBaixa, bool AtivaInscricao, bool AtivaEvento, bool EventoTipo,
